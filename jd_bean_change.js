...
/*    if (typeof $.totalMoney !== "undefined") {
    ...
    ReturnMessage += `🐹萌宠进度：(${(response.result.medalPercent).toFixed(2)}%),已集勋章${response.result.medalNum}|${response.result.medalNum+response.result.needCollectMedalNum}块\n`;
